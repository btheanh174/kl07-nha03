...
<ul class="menu">
	<li><a href="<s:url action="index"/>" class="nav1"> Trang chủ
	</a>
	</li>
	<li class="divider"></li>
	...
	<s:if test="#session['tk'] == null">
		...
		<li><a href="<s:url action="show_user_register"/>"
			class="right_nav4">Đăng ký</a>
		</li>
	</s:if>
	<s:elseif test="#session['tk'] != null && #session['nhomNguoiDung']==2">
	...
	<li class="right_divider"></li>
	<li><a href="<s:url action="XemGioHang"/>" class="right_nav3">Giỏ
			hàng</a>
	</li>
