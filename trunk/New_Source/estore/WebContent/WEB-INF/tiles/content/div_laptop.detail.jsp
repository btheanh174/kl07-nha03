...
<div class="block_title"><span>Chi tiết sản phẩm</span></div>
...
<div class="product_img_big"><a href="#" title=""><img
	src="${hinhAnh}" alt="" title="" border="0" class="chitiet_laptop" />
</a></div>
<div class="details_big_box">
<div class="product_title_big"><s:property value="tenSanPham" />
</div>
<div class="specifications">
<p>Số lượng: <span class="blue">1</span><br />
Chất lượng: <span class="blue">Mới</span><br />
Phí vận chuyển: <span class="blue">Liên hệ</span><br />
Xuất xứ: <span class="blue">Chính hãng</span></p>
</div>
<div class="prod_price_big"><strong><span class="price"><b><s:property
...
<sj:div>
	<sj:tabbedpanel id="laptop" animate="true" collapsible="true"
		...
		<div id="four"><s:iterator value="dsHinhAnh">
			<div><img alt="" src="${urlHinhAnh}"></div>
		</s:iterator></div>
	</sj:tabbedpanel>
</sj:div>
