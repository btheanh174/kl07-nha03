...
public class Laptop extends SanPham {
	...
	public Laptop(String tenSanPham, Integer gia, String hangSanXuat,
	...
	public String toLongString() {
		...
		str.append(" / Hệ đi�?u hành: " + heDieuHanh);
		str.append(" / Chuột: " + chuot);
		str.append(" / Pin: " + pin);
		str.append(" / Tr�?ng lượng: " +  trongLuong);
		str.append(" / Kích thước màn hình: " + kichThuocManHinh);
		str.append(" / �?ộ phân giải: " + doPhanGiai);
