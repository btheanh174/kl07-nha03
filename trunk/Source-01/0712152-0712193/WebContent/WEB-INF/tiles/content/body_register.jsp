...
<div class="center_prod_box_big">
	...
	<s:actionerror/>
			...
			<s:bean name="model.bean.TinhThanhPhoData" id="ttpData"></s:bean>
			<s:select name="tinhThanhPho" list="#ttpData.dsTinhThanhPho" listKey="maTinhThanhPho" listValue="tenTinhThanhPho"></s:select>
