...
<%@ taglib prefix="s" uri="/struts-tags" %>
	...
	<div class="center_title_bar">Sản phẩm mới nhất</div>
   	...
   	<div class="prod_box">
           ...
           <a href=" <s:url action="show_product_detail" />" title="header=[Chi tiết] body=[&nbsp;] fade=[on]" class="prod_details">Chi tiết</a>            
           </div>                     
    </div>
	...
	<div class="center_title_bar">Sản phẩm đề nghị</div>
