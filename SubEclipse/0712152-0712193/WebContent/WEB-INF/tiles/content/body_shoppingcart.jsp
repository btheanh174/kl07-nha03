				...
				<tr>
					...
					<table cellspacing="0" cellpadding="0" border="0" width="100%">
						<tbody>
							...
							<s:iterator value="#session['gh'].getEnumeration()" status="stat">
								<tr>
									<td align="center" valign="top">
										<input type="checkbox" name="dsDuocChon" value="${sanPham.maSanPham }">
									</td>
									<td>
									...
									<td align="center" valign="top">
										<input type="text"
										size="4" value="${soLuong }" name="dsSoLuong" />
										<input type="hidden" name="dsMaSanPham" value="${sanPham.maSanPham}">
